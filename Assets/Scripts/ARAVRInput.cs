...
# endif
    ...
    public static Vector3 RHandDirection
    {
        ...
        {
#if PC
            Vector3 direction = RHandPosition - Camera.main.transform.position; RHand.forward = direction;
            return direction;
#elif Oculus
    ...
    Controller hand)
    {
        ...
        CoroutineInstance.coroutineInstance.StartCoroutine(CoroutineInstance.VibrationCoroutine(duration, frequency, amplitude, hand));
#endif
    }
...
#if Oculus
    public static IEnumerator VibrationCoroutine(float duration, float frequency, float amplitude, ARAVRInput.Controller hand)
    {
        float currentTime = 0;
